  ...
  return (
    ...
    >
      ...
      <button
        ...
        onMouseLeave={e => { if (!open) e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.04)'; }}
      >
      ...
      {open && (
        <div style={{
          ...
          ...(typeof window !== 'undefined' && ref.current &&
            ref.current.getBoundingClientRect().bottom + 280 > window.innerHeight
            ? { bottom: 'calc(100% + 6px)', top: 'auto' }
            : {}),
        }}>
          {/* Section label */}
          <p style={{ fontSize: 10, color: '#334155', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.6px', padding: '4px 8px 8px', fontFamily: "'DM Sans', sans-serif" }}>
            Select Language
          </p>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{ color: isActive ? '#38bdf8' : '#f1f5f9', fontSize: 12, fontWeight: isActive ? 600 : 400, margin: 0 }}>
                      {lang.nativeLabel}
                    </p>
                  ...
                  {isActive && (
                    <Check size={13} color="#38bdf8" style={{ flexShrink: 0 }} />
                  )}
                </button>
              );
            })}
