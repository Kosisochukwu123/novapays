  ...
  cors({
    origin: function (origin, callback) {
      ...
      const allowed = [
        ...
        "https://novapays-b4os2zl34-kosisochukwu123s-projects.vercel.app",
        "https://novapays.vercel.app",
      ].filter(Boolean);

      // Also allow ANY subdomain of vercel.app for this project
      const isVercelPreview = origin?.includes(
        "kosisochukwu123s-projects.vercel.app",
      );
